...
class TaskOverallApi {
  static Future<List<TaskModel>> getFilterTask(
    ...
    if (response.statusCode == 201 || response.statusCode == 200) {
      ...
      listTask.addAll(jsonData
          .map((listTask) => TaskModel.fromJson(listTask))
          .cast<TaskModel>());
      return listTask;
    } else {
  ...
  static Future<List<TaskModel>> getTask(
    ...
    var response = await http.get(
      Uri.parse(
          '${BaseLink.localBaseLink}${BaseLink.getTask}?fieldName=eventID&conValue=$eventID&sizePage=100&currentPage=1'),
      headers: {
        "Accept": "application/json",
        "content-type": "application/json",
        'Authorization': 'Bearer $jwtToken',
