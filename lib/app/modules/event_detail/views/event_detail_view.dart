                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(
                            ...
                            size: 25,
                            color:
                                controller.eventDetail.value.status == "PENDING"
                                    ? Colors.grey.withOpacity(0.8)
                                    : controller.eventDetail.value.status! ==
                                            "PROCESSING"
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.only(
                                left: UtilsReponsive.width(10, context)),
                            child: Text(
                              ...
                              style: TextStyle(
                                  letterSpacing: 1.5,
                                  fontFamily: 'Roboto',
                                  color: controller.eventDetail.value.status ==
                                          "PENDING"
                                      ? Colors.grey.withOpacity(0.8)
                                      : controller.eventDetail.value.status! ==
                                              "PROCESSING"
                      ...
                      Row(
                        children: [
                          ...
                          controller.eventDetail.value.location == null ||
                          ...
                          controller.eventDetail.value.estBudget == null
                              ...
                              : Text(
                                  controller.formatCurrency(
                                      controller.eventDetail.value.estBudget!),
                                  style: TextStyle(
                                      fontFamily: 'Roboto',
                                      wordSpacing: 1.2,
                                      color: ColorsManager.primary,
