                                    ...
                                    () => Stack(clipBehavior: Clip.none, children: [
                                      GestureDetector(
                                        onTap: () async {
                                          ...
                                          if (controller.listNotifications[index].type == "TASK") {
                                            Get.toNamed(Routes.TASK_DETAIL_VIEW, arguments: {"taskID": controller.listNotifications[index].commonId});
                                          } else if (controller.listNotifications[index].type == "SUBTASK") {
                                            await controller.getTaskDetail(controller.listNotifications[index].commonId, index);
                                          } else if (controller.listNotifications[index].type == "COMMENT_SUBTASK") {
                                            await controller.getTaskDetail(controller.listNotifications[index].commonId, index);
                                          } else if (controller.listNotifications[index].type == "COMMENT") {
                                            Get.toNamed(Routes.TASK_DETAIL_VIEW, arguments: {"taskID": controller.listNotifications[index].commonId});
                                          }
                                        },
                                        child: Container(
